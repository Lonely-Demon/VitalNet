# Security Remediation Log: ROOT-SEC-002

## Unit Metadata
- **Unit ID**: ROOT-SEC-002
- **Priority**: P0
- **Title**: JWT payload decoded without verification; user_metadata.role used for authorization allowing privilege escalation
...
## Finding Summary
JWT payload decoded without verification; user_metadata.role used for authorization allowing privilege escalation
