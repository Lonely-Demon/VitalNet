# Security Remediation Log: R3-SEC-AUTH-R3-012

## Unit Metadata
- **Unit ID**: R3-SEC-AUTH-R3-012
- **Priority**: P3
- **Title**: Session Tokens Visible in Browser DevTools Network Tab
- **Source IDs**: SEC-AUTH-R3-012
- **Location**: All API calls with `Authorization: Bearer` headers
- **Status**: 🚧 BLOCKED / PARTIAL

## Finding Summary
Session Tokens Visible in Browser DevTools Network Tab
