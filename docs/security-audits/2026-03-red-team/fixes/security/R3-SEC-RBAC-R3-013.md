# Security Remediation Log: R3-SEC-RBAC-R3-013

## Unit Metadata
- **Unit ID**: R3-SEC-RBAC-R3-013
- **Priority**: P3
- **Title**: Profile Updates via Supabase Client Don't Validate Role Changes
- **Source IDs**: SEC-RBAC-R3-013
- **Location**: `frontend/src/store/authStore.jsx:28-40`
- **Status**: 🚧 BLOCKED / PARTIAL

## Finding Summary
Profile Updates via Supabase Client Don't Validate Role Changes
