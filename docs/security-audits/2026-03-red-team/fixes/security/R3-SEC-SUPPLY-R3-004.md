# Security Remediation Log: R3-SEC-SUPPLY-R3-004

## Unit Metadata
- **Unit ID**: R3-SEC-SUPPLY-R3-004
- **Priority**: P1
- **Title**: serialize-javascript RCE in vite-plugin-pwa Build Chain (GHSA-5c6j-r48x-rmvq)
...
## Finding Summary
serialize-javascript RCE in vite-plugin-pwa Build Chain (GHSA-5c6j-r48x-rmvq)
