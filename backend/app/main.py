...
from app.api.routes import cases, admin_routes, analytics_routes, security, push_routes, referral_routes, dsr_routes, voice_routes, metrics_routes, supervisor_routes, outbreak_routes, protocol_routes
...
app.include_router(outbreak_routes.router)
