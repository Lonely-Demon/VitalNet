...
-- 00000000-0000-0000-0000-000000000w01   CI ASHA Worker PHC A
...
VALUES
  ...
  ('00000000-0000-0000-0000-000000000w01')
ON CONFLICT (id) DO NOTHING;
...
-- ASHA Worker A → PHC A
INSERT INTO public.profiles (id, full_name, role, facility_id, is_active)
VALUES ('00000000-0000-0000-0000-000000000w01', 'CI ASHA PHC A', 'asha_worker', '00000000-0000-0000-0000-0000000000f1', true)
ON CONFLICT (id) DO NOTHING;
...
SELECT set_config(
  'request.jwt.claims',
  '{"sub":"00000000-0000-0000-0000-000000000w01","role":"authenticated"}',
  false
);
